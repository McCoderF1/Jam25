...
namespace Jam25.Screens
{
    ...
    {
        public ScreenManager(StartScreen startScreen, SettingsScreen settingsScreen, GameScreen gameScreen, PlayerScreen playerScreen, TransitionHandler transitions, DeathScreen deathScreen)
        {
